...
public class RemarkCartoonActivity  extends MyActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.remark_cartoon_recycler_view);
        back = findViewById(R.id.remark_cartoon_back);
        ...
        CartoonDao.getRemarkCartoon(sharedPreferences.getString("userId","0"),handler);
    }
