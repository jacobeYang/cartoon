...
public class LikeCartoonActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)findViewById(R.id.like_cartoon_recycler_view);
        back = (ImageView)findViewById(R.id.like_cartoon_back);
