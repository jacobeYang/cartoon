...
public class LikeCartoonActivity extends MyActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.like_cartoon);

        recyclerView = findViewById(R.id.like_cartoon_recycler_view);
        back = findViewById(R.id.like_cartoon_back);
        ...
        CartoonDao.getLikeCartoon(sharedPreferences.getString("userId","0"),handler);
    }
